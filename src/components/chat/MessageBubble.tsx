    ...
    >
      <div
        className={cn(
          ...
          isUser ? "bg-secondary text-secondary-foreground order-2" : "bg-primary text-primary-foreground"
        )}
      >
        {isUser ? (
      ...
      <div
        className={cn(
          "relative px-5 py-3 rounded-2xl shadow-md transition-all duration-300 text-left max-w-[70%]",
          isUser
